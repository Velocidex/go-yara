...
# Get this patch by:
# 1. Manually getting it to compile cleanly.
# 2. Commit the working files.
# 3. Comment out the patch below.
# 4. Run the update script
# 5. Obtain the patch by git diff -R *.[ch] > scripts/yara_src.diff
